...
public class Frm_Fase3 extends javax.swing.JFrame {
    double numero = Math.random()*300;
    double numero_gerado = Math.round(numero);
    int tentativas = 0;

    public Frm_Fase3() {
        initComponents();
        this.setTitle("Chutômetro LEVEL 3");
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("LEVEL3");

        jLabel4.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel4.setText("CHUTÔMETRO");

        jLabel5.setText("1~300");
    ...
    private void Btn_VerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_VerificarActionPerformed
        ...
        int confirma = JOptionPane.showConfirmDialog(this,"Próximo Level?");
        if (confirma == 0){
            Frm_Fase4 s = new Frm_Fase4();
            s.setVisible(true);
            this.dispose();
            }
        if (confirma ==1){
